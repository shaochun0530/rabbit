...
from rabbitTest.services.rabbit.dependencies import \
    get_rmq_channel_pool
from rabbitTest.services.rabbit.lifetime import (init_rabbit,
                                                                    shutdown_rabbit)

from rabbitTest.settings import settings
from rabbitTest.web.application import get_app
from sqlalchemy.ext.asyncio import (AsyncConnection, AsyncEngine, AsyncSession,
                                    async_sessionmaker, create_async_engine)
from rabbitTest.db.dependencies import get_db_session
from rabbitTest.db.utils import create_database, drop_database
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from rabbitTest.db.meta import meta  # noqa: WPS433
    from rabbitTest.db.models import load_all_models  # noqa: WPS433
